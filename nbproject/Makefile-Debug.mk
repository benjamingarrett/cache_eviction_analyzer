...
${OBJECTDIR}/_ext/d6f51a9a/indexed_skiplist.o: ../indexed_skiplist/indexed_skiplist.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d6f51a9a/indexed_skiplist.o ../indexed_skiplist/indexed_skiplist.c

${OBJECTDIR}/_ext/d6f51a9a/indexed_skiplist_long_int.o: ../indexed_skiplist/indexed_skiplist_long_int.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/d6f51a9a
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d6f51a9a/indexed_skiplist_long_int.o ../indexed_skiplist/indexed_skiplist_long_int.c
...
${OBJECTDIR}/_ext/554cfc1b/memo_long_int.o: ../memoization/memo_long_int.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/554cfc1b
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/554cfc1b/memo_long_int.o ../memoization/memo_long_int.c

${OBJECTDIR}/cache_eviction_analyzer.o: cache_eviction_analyzer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cache_eviction_analyzer.o cache_eviction_analyzer.c
